...
|The best feature about this device is the gradual smart lighting. That is what sold me and the sole reason why I love this thing so much. I am not a morning person. I’m instantly in bad mood if someone else wakes me up including my own alarm I set myself on my phone. Since having this, I’ve been waking up so peacefully and I can honestly say I’ve been in way better moods which says a lot for someone who hates waking up early and loves sleeping.                        |5.Gradual smart lighting is gentler than phone alarms. (Latent)
|            | 6.Wakes up non morning people in a better mode. (Explicit)
...
|Very disappointing. The hardware is good but the app is unusable. There is a lot of potential in this product but they will only realize it when they throw out the current app and rebuild it with ease of use and flexibility in mind.                     |5.the app is is too rigid too and hard to use. (Explicit)
...
|The app is okay, the food dispenser part is okay. I wish there was a notification to tell when the food runs out or is low. Works as needed as i like the portion sizes/automation. I absolutely hate the water dispenser part. I stopped using it almost immediately because it harbors so much bacteria.                         |5.Doesn't let the owners know when the food is out in the bowl. (Latent)
|            | 6.Doesn't properly keep the water clean enough to drink for long drations. (Explicit)
...
| Voice of the Customer                                                                                                                                                                  | Restated Customer Need                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
|"This is a great tool for helping my family visualize time expectations. It is easy to use - very easy to select the time, easy to pause/reset, and very clear how much time is left. The only downside for us is the piercing alarm noise, but it's very clear when the time is up."  |   1. Clear way to set the timer to what you want (explicit)                         |
...
|"Love this little timer. My son is autistic and he appreciates that it gives him a warning before time is up."                       |5.Gives a heads up before the time is over. (Latent)                                                                                                                                                                                    

##### Negative Comments

| Voice of the Customer                                                                                                                                                                                                                                                                                                                                                                                | Restated Customer Need                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
|It worked when I turned it on to try it then never again. It would simply not turn on. New batteries made no difference. A total waste of money, do not buy one of these!                        |1. Needs to work consistently over time (explicit)
...
| Voice of the Customer                                                                                                                                                                  | Restated Customer Need                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| "Great value for the money. It does what I needed it to do. I just wish there was a way to know when it was empty. The instructions say the food lasts about 2 weeks and that's probably right. But I have to go off memory so if I forget I still end up with my cat in my bed at 6AM ready to slit my throat. It would be cool if there was a little light or a window or something." |   1. Have a light to notify when there needs to be more food added (explicit)                         |
...
|"This feeder has made a major improvement in our ability to control our cat's weight. When we adopted our 10 year old cat from a shelter, he was seriously overweight. He's extremely food motivated and tends to 'scarf and barf'. We needed a way to feed him several small portions over the course of the day without needing to be home every few hours. And that's where this feeder has made a huge difference."                        |5.Can help overweighted cat loss weight over time. (Explicit)

##### Negative Comments

| Voice of the Customer                                                                                                                                                                                                                                                                                                                                                                                | Restated Customer Need                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| "I bought this 2 weeks ago. The food dispenses exactly at the times I set but the portions are way off. My Cat gets about 2/3 of a cup of food morning and evening. The setting for that amount delivered 3 times that amount of food. so I started lowering the number. Finally I am down to setting #2 which should dispense only an 1/8 of a cup but we are receiving about 2/3 of a cup. I plan to return the unit and will get another one hoping it works acurately."                       | 1. Relase accuarte portions that you set (explicit)
...
| Voice of the Customer                                                                                                                                                                  | Restated Customer Need                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
|"Very practical - easy to use, always available, excellent if we're missing home 1-2 days"  |   1. Ready to use once recieved (explicit)                         |
...
|"This product is very easy to clean, everything comes off easily with a little twist. The water tank can hold a lot. At first, I was a little skeptical with filling the water to the top, so I was doing half fills. However, you can fill this to the top and it’ll stop itself when it’s full because of the water cap’s mechanism."                        |5. The product is easy to maintain. (Explicit) 
|            | 6. has a lot of water storage. (Latent)

##### Negative Comments

| Voice of the Customer                                                                                                                                                                                                                                                                                                                                                                                | Restated Customer Need                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
|"Constantly overflows. I'd say a good 20% of it ends up on your floor. I have a mat under it that catches the water but it's really a pain in the ass to keep soaking it up. It seems like if you only fill the bottle up halfway it's not so bad but that's not really the point of buying something and not using it to its fullest capacity. The picture was taken almost immediately after one of my pets drank and then it refilled and overflowed. I'd send it back but it'll be just too much of a hassle, but I definitely would pass on this if I had to do it again."                        |1. Need prevention for an overflow (explicit)
...
|"If your buying for inside it ok the only problem is the top for the food it doesn’t screw on and it’s loss hard to load the feed . I use mine for outside a storm came up and blew the top off to the feeder."                        |5.The feeders lid is not on their good. (Explicit)
|            | 6.Not built for outdoors. (Latent)
...
| Voice of the Customer                                                                                                                                                                  | Restated Customer Need                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
|"I’m really happy with the Amazon Echo Dot. It’s compact but surprisingly useful, and the sound quality is good for its size. Setup was quick and easy, and Alexa responds well to commands. I love being able to use it for music, timers, reminders, and controlling compatible smart devices. Overall, it’s a convenient little smart speaker and a great addition to my home."  |   1. Easy to set up (explicit)                         |
...
|I m very happy with my Echo Dot It s easy to set up and use and the sound quality is surprisingly good for its size Alexa responds quickly and is very helpful for playing music, setting alarms, checking the weather, and controlling compatible smart devices.                       |5. Sound quality is good. (Explicit)
|            | 6.Helpful at answering questions. (Latent)

##### Negative Comments

| Voice of the Customer                                                                                                                                                                                                                                                                                                                                                                                | Restated Customer Need                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| "Was told it would be better speaker and could hear me speaking better. Maybe a little but not a great improvement. Should have stuck with original echo dot/Alexa. Im finding Alexa more and more annoying, too chatty, constant mistakes, constant repetiveness and less and less usefulness. It almost gets argumentive in ways as it is so locked in and programmed that its way and its answers are the gospel. I am instead using Google Home more and more instead as less annoying and more helpful. Alexa is a pain in the you know what"| 1. Have a reliable way to communicate with the device (latent)
...
| Voice of the Customer                                                                                                                                                                  | Restated Customer Need                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
|"5 stars immediately. I've been looking for a simple alarm clock and this one is great! It's basic, no frills and very easy to set up. The light from the clock is distinct and easy to read in the day, and not too bright at night. Doesn't seem to heat up, and the cord is pretty long. The alarm function is loud! But the basic tone is good. Great value for money."  |      1. Display is good for bright and dark rooms (explicit)                    |
...
|Good clock, cheap price just needed something to keep an eye on time. Never used the alarm clock. Easy to read, easy to set up. decent size. Lights are pretty bright.                        |5. Pretty cheep clock for telling time. (Latent)

##### Negative Comments

| Voice of the Customer                                                                                                                                                                                                                                                                                                                                                                                | Restated Customer Need                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
"Bought this product in May. It's now August, and it already doesn't work. It tells the time, but the alarm won't sound. It worked just fine until a few weeks ago. Now the alarm is useless and I have slept through several appointments because this defective piece of junk decided to stop working. Never buy an Amazon basic product. And of course the return date was LAST MONTH. Convenient how these products always tank right after it's too late to return them. Waste of money."|  1. Need a reliable alarm to notify someone (explicit)                       |
...
|This is NOT a battery powered alarm clock like I thought I was getting. Partially my bad for not reading close enough, but mostly the Amazon algorithm’s fault for pushing Amazon branded products that do not match my search criteria.                       |5. Not a battery powered clock. (Explicit)
|            | 6.clock is missed labled. (Latent)
...
<img src="https://m.media-amazon.com/images/I/71MXD3kWrwL._AC_SX679_.jpg" alt="Automatic Animal Drinking Water Bowl, 304 Stainless Steel Waterer" width="500">
...
|The dogs love it and it is simple and easy to install. Screwed it to the wall and hooked up the water. It is a great size for all dogs made of quality materials, no leaks and a good value overall.                       |5.Good size for dogs. (latent)
|            | 6.Built with quality materials. (Explicit)
...
|"Included instructions were not helpful. The bowl does not have a flat bottom, so is very unstable if you choose not to attach it to the wall, but use it on the ground or floor."                      |5.Instruction on product is not clear. (latent)
|            | 6. Not built to be place on flat ground. (Explicit)
...
<img src="https://m.media-amazon.com/images/I/71KYFpHB6EL._AC_SX679_.jpg" alt="Tabtime Vibrating Alarm Reminder Watch" width="300">
...
| Voice of the Customer                                                                                                                                                                  | Restated Customer Need                                                              |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
|"This is comfortable, doesn’t wake my spouse, lightweight, and amazingly holds charge forever. I bought it like a month ago and it’s still at 100% battery without ever charging it. I think the instruction manual says that it drain more battery if you set more alarms, but I only use 1 of the 10 alarms available. Entirely programable down to the minute. It’s extremely simple and very reliable."  | 1. Not an inconvenience to have on (explicit)                           |
...
|"Setting alarms and turning them on and off is not complicated. Info provided by the watch is easy to read. Wrist band is very comfortable and has proven to be of good quality. On my wrist it looks like an unusual bracelet and I like that. If I need to know what time it is I can always easily find out but time is not constantly staring me in the face."                      |5.Using the watch is easy. (Explicit)
|            | 6.The watch is comfortable to wear. (Explicit)

##### Negative Comments

| Voice of the Customer                                                                                                                                                                                                                                                                                                                                                                                | Restated Customer Need                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
|"This is a nice watch to have if you simply want a simple digital watch that’s not water proof. The vibration isn’t very strong. I ordered the unused large version of the watch and I can’t tell what’s large about it. Aesthetically speaking it’s a hit or miss depending on one’s fashion sense but for the purpose of waking you up out of your sleep your better off buying an alarm clock or trying a completely different style of alarm watches entirely."                       |1. Need a strong vibration capable of waking someone up (explicit)
...
|I would rate this product better but it stopped working about 2 months after purchase. Similar to other people, some numbers would light up while others wouldn't and there was no way to reset it.                       |5.The durability of the alarm system is not good. (Latent)
|            | 6.Their is no way to reset the watch. (Explicit)
