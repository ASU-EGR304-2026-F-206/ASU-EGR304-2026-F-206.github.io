...
* What happens if the food jams the motors?
* How visible are the LEDs from across the room?
* Are the LEDs dimmable for nighttime?
* How many days of food can the tank hold?
* Do owners get an alert on their phone or just rely on the LED?
